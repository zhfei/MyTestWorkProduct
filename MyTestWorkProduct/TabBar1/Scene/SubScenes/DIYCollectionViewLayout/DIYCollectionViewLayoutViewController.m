//
//  DIYCollectionViewLayoutViewController.m
//  MyTestWorkProduct
//
...
@interface DIYCollectionViewLayoutViewController ()

@end

@implementation DIYCollectionViewLayoutViewController

static NSString * const reuseIdentifier = @"Cell";

- (instancetype)initWitDefontLayout
{
