...
#define kUIButton_Badge_MiniSize 4.0f
...
- (void)badgeInit
{
    ...
    self.badgePadding   = 6;
    self.badgeMinSize   = kUIButton_Badge_MiniSize;
...
- (void)updateBadgeFrame
{
    ...
    self.badge.frame = CGRectMake(self.badgeOriginX - 25, self.badgeOriginY + 12, minWidth + padding, minHeight + padding);
...
//    return number.floatValue;
    ...
    return kUIButton_Badge_MiniSize;
}
