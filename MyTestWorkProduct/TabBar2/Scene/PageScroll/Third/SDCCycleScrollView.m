...
#import "SDCCycleScrollViewCell.h"
#import "SDCCycleScrollViewFlowLayout.h"
#define kScreenWidth  [UIScreen mainScreen].bounds.size.width

@interface SDCCycleScrollView()<UICollectionViewDataSource,UICollectionViewDelegate>
@property (nonatomic,strong) UIImageView *backgroundImageView;
@property (nonatomic,strong) SDCCycleScrollViewFlowLayout *flowLayout;
...
@implementation SDCCycleScrollView
{
    float _oldPoint;
...
{
    SDCCycleScrollView *cycleScrollView = [[SDCCycleScrollView alloc]initWithFrame:frame];
...
{
    SDCCycleScrollViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
...
-(UICollectionView *)collectionView
{
    if(_collectionView == nil)
    {
        ...
        //注册cell
        [_collectionView registerClass:[SDCCycleScrollViewCell class] forCellWithReuseIdentifier:cellID];
...
-(SDCCycleScrollViewFlowLayout *)flowLayout
{
    if(_flowLayout == nil)
    {
        _flowLayout = [[SDCCycleScrollViewFlowLayout alloc]init];
