...
@class SDCCycleScrollView;
@protocol DCCycleScrollViewDelegate <NSObject>
/** 点击图片回调 */
- (void)cycleScrollView:(SDCCycleScrollView *)cycleScrollView didSelectItemAtIndex:(NSInteger)index;
@end


@interface SDCCycleScrollView : UIView
